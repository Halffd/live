...
var handler = handlerFactory({
  ...
  printer: (channel) => {
    ...
    console.log(chalk2.gray((_a = channel.description) == null ? void 0 : _a.slice(0, 120), "..."));
  }
});
var command = {
  command: "channel <id>",
...
var handler2 = handlerFactory({
  ...
  printer: (videos) => {
    for (const video of videos) {
      ...
      console.log(chalk3.gray(fromNow(video.scheduledStart)));
    }
  }
});
var command2 = {
...
var handler3 = handlerFactory({
  ...
  printer: (video) => {
    var _a;
    console.log(videoLink(video.videoId, video.title));
    console.log(chalk4.gray((_a = video.description) == null ? void 0 : _a.slice(0, 120), "..."));
  }
});
var command3 = {
  command: "video <id>",
...
// src/cli.ts
yargs(process.argv.slice(2)).scriptName("holodex").help("help").alias("help", "h").option("json", {
  alias: "j",
  desc: "Print JSON"
}).option("token", {
  type: "string",
